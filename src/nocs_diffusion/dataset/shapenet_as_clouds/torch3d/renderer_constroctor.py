...
class RendererConstroctor:

    def __init__(self, aspect_ratio=1.0, cam_fov=60, znear=0.1, zfar=100,
                    image_size=64, pt_radius=0.05, pts_per_pxl=5,
                    Renderer=PointRgbdRenderer, Compositor=AlphaCompositor):
    ...
    def __call__(self, feat_size, Rs, Ts, device):
